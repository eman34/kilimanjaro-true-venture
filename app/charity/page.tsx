    ...
    <>
      ...
      <section className="py-6 md:py-7 bg-parchment">
        <div className="max-w-3xl mx-auto px-4 md:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-olive mb-12 text-center">
            How You Can Help
          </h2>
          <div className="space-y-8">
            {/* Participate in Community */}
            <div className="bg-paper rounded-xl p-8 border border-taupe/10">
              <h3 className="text-2xl font-bold text-gold-deep mb-4">
      ...
      <section className="section-padding">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6 text-olive/85 leading-relaxed">
            <p className="text-olive text-lg text-center font-semibold">
      ...
      {/* Abu's Words */}
      <section className="section-padding bg-gradient-to-b from-olive to-olive/10">
        <div className="max-w-3xl mx-auto text-center">
          <blockquote className="text-xl md:text-2xl text-olive italic leading-relaxed mb-6">
