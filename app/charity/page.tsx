    ...
    <>
      ...
      <section className="section-padding">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6 text-forest/70 leading-relaxed">
            <p className="text-forest text-lg text-center font-semibold">
      ...
      {/* Abu's Words */}
      <section className="section-padding bg-gradient-to-b from-forest to-forest/10">
        <div className="max-w-3xl mx-auto text-center">
          <blockquote className="text-xl md:text-2xl text-forest italic leading-relaxed mb-6">
