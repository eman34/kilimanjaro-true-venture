    ...
    <>
      ...
      <section className="section-padding">
        <div className="text-center mb-16">
          ...
          <p className="text-gold-deep text-2xl font-bold mb-4">Starting from $1,370</p>
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="space-y-6">
            {SAFARI_ITINERARY.map((day) => (
              <div
                key={day.day}
                className="bg-parchment rounded-xl p-6 md:p-8 border border-taupe/10 relative overflow-hidden"
              >
        ...
        {/* Includes */}
        <div className="max-w-2xl mx-auto bg-parchment rounded-xl p-8 border border-taupe/10">
          <h3 className="text-xl font-bold text-gold-deep mb-4 text-center">Package Includes</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              <div key={item} className="flex items-center gap-2 text-olive/85 text-sm">
                <svg className="w-4 h-4 text-gold-deep shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {SAFARI_PARKS.map((park) => (
              ...
              >
                <div className="h-40 bg-gradient-to-br from-olive to-khaki relative">
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {park.highlights.map((h) => (
                      <span
                        key={h}
                        className="bg-olive/30 text-olive/95 text-xs px-3 py-1 rounded-full"
                      >
                        {h}
                      </span>
                    ))}
