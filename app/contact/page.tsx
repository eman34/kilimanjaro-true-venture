...
export default function ContactPage() {
  return (
    <>
      {/* Header */}
      <section className="pt-16 pb-12 bg-gradient-to-b from-wine/20 to-wine">
      ...
      <section className="section-padding pt-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            <h2 className="text-2xl font-bold text-wine mb-6">
              Send Us an Inquiry
            </h2>
            <InquiryForm />
          </div>
            ...
            <div className="space-y-6">
              <div className="bg-parchment rounded-xl p-6 border border-taupe/10">
                ...
                <a
                  ...
                  className="text-wine/70 hover:text-emerald transition-colors break-all"
                >
                  {COMPANY.email}
                </a>
              </div>
              ...
              <div className="bg-parchment rounded-xl p-6 border border-taupe/10">
                ...
                <a
                  ...
                  className="text-wine/70 hover:text-emerald transition-colors"
                >
                  {COMPANY.phone}
                </a>
              </div>
              ...
              <div className="bg-parchment rounded-xl p-6 border border-taupe/10">
                ...
                <p className="text-wine/40 text-xs mt-1">
              ...
              <div className="bg-parchment rounded-xl p-6 border border-taupe/10">
                ...
                <p className="text-wine/70">{COMPANY.address}</p>
              </div>

              <div className="bg-parchment rounded-xl p-6 border border-taupe/10">
                <h3 className="text-emerald font-bold mb-3">Response Time</h3>
                <p className="text-wine/70">
                  We typically respond within <strong className="text-wine">24 hours</strong>.
