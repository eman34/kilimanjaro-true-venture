    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
            ...
            {TEAM_MEMBERS.map((member) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-base text-forest/70 leading-relaxed">
                    {member.bio}
                  </p>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto mt-20">
            <div className="bg-paper rounded-xl p-8 border border-taupe/10">
              ...
              <p className="text-forest/50 text-sm mb-4">Every expedition is supported by:</p>
              <ul className="space-y-3">
                {MOUNTAIN_CREW.map((role) => (
                  <li key={role} className="flex items-center gap-3 text-forest/70">
            ...
            <div className="bg-paper rounded-xl p-8 border border-taupe/10">
              ...
              <p className="text-forest/50 text-sm mb-4">Our safari team includes:</p>
              <ul className="space-y-3">
              ...
              <p className="text-forest/50 text-sm mt-4">
      ...
      <section className="section-padding">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-forest text-center mb-4">
            Safety & Ethics
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {VALUES.map((value, i) => (
              ...
              >
                ...
                <p className="text-forest/60 leading-relaxed">{value.description}</p>
              </div>
            ))}
          </div>
        </div>
