...
export default function StickyWhatsApp() {
  // WhatsApp URL needs phone digits only (strip spaces, plus, hyphens)
  ...
  return (
    ...
    >
      ...
      <span className="text-sm">
        <span className="hidden sm:inline">Abu replies in 4 hours · </span>
        WhatsApp
      </span>
    </a>
  );
