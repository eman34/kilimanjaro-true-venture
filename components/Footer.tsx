          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center hover:bg-secondary hover:text-dark transition-all"
            ...
            <div className="mt-6">
              ...
              <a
                ...
                className="text-secondary hover:text-yellow-400 transition-colors font-medium"
              >
                {COMPANY.whatsapp}
              </a>
            </div>
